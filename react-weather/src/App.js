...
class App extends React.Component {
  ...
  makeApiCall = async city => {
    const api_data = await fetch(
      `https://api.openweathermap.org/data/2.5/forecast?q=${city}&APPID=e139e14362msh6c3168c48af591fp15f02ejsn11764f6adab6`
      // `https://api.openweathermap.org/data/2.5/weather?q=${city}&mode=xml `
    ).then(resp => resp.json());
